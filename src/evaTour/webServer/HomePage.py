...
""" + getMenu(0) + """
    ...
    <div class="jumbotron jumbotron-fluid position-relative overlay-bottom" style="margin-bottom: 90px;">
        <div class="container text-center my-5 py-5">
            <h1 class="text-white mt-4 mb-4">evolution algorithm based recommender</h1>
            <h1 class="text-white display-1 mb-5">Plan Tourist Roundtrip</h1>
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            <div class="row">
                <div class="col-lg-5 mb-5 mb-lg-0" style="min-height: 475px;min-width: 475px">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100" src="img/pngwing.comScaled.png" style="object-fit: cover;">
                    </div>
                </div>
                <div class="col-lg-7">
                    <div class="section-title position-relative mb-4">
                        <h6 class="d-inline-block position-relative text-secondary text-uppercase pb-2">Home</h6>
                        <h1 class="display-4">Recommender for Round Trips</h1>
                    </div>
                    <p>We introduce recommender system in domain of tourism.  The result of personalised recommendation is not only list of destinations, but even roundrip. The goal is to provide relevant recommendationsvenues organised to roundtrips.The recommended venues are selected and ordered to be walkable.</p>
                    <p>System recommends in multiple destinations.  The most favorite recommender is for NYC tourists.</p>
